...
//     "smile":["Please Smile","Complete this task by smiling infront of your camera after pressing 'Ok'"], 
//     "look_left":["Turn your head to the Left","Complete this task by turning your head to the left after pressing 'Ok'"],
//     "look_right":["Turn your head to the Right","Complete this task by turning your head to the right after pressing 'Ok'"]};
...
//                             waitTime = ( random.nextInt(5) + 3 ) * 1000 ;
...
//                         _ryanAppBarText = actionMessages[action][0] +  " for ${waitTime/1000} sec";
...
//                             imglib.copyResize(image, width: 150, height: 150);
...
//                       var res = await sendDataToServer(api_url, jwt_token, bvn, File(finalImagePath));
//                       if(res['status']==1){
//                         Navigator.pushNamed(
//                           context,
//                           LoginSuccessScreen.routeName,
...
//             }else{  // else if youve have crossed the limit to keep the camera open
...
//     List<String> listOfActions = ['look_left','look_right','smile'];
...
//   Future<Map> sendDataToServer(String apiEndpoint, String token, String bvn, File image) async{

//     var request = http.MultipartRequest(
//       'POST',
//       Uri.parse(apiEndpoint),
//     );
//     Map<String, String> headers = {"Content-type": "multipart/form-data","x-access-token":token};
//     request.files.add(
//       http.MultipartFile(
//         'image_file',
